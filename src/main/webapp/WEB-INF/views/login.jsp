...
<head>
  ...
  <link href="${contextPath}/resources/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="${contextPath}/resources/assets/css/soft-ui-dashboard.css?v=1.0.7" rel="stylesheet" />
</head>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('${contextPath}/resources/assets/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
